            ...
            <div className="w-full py-10 px-10">
                <div className="rounded-lg flex h-full flex-col overflow-y-scroll bg-white shadow-xl dark:bg-gray-800 dark:text-white">
                    ...
                    <div className=" px-4 py-6 sm:px-6">
                        ...
                        <div className="mt-6">
                            <button onClick={checkout} className="flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-blue-700">Proceed to Checkout</button>
                        </div>
                        <div className="mt-6">
