    ...
    return (
        <div>
            <div className="m-1 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="# w-[384px] h-[283.5px]">
                    <img className="p-8 rounded-t-lg w-[384px] h-[283.5px] object-contain" src={props.image || appleWatch} alt="product image" />
                </a>
                <div className="px-5 pb-5">
                    <a href="#">
                        <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{props.name || 'Name'}</h5>
                    </a>
                    <div className="flex items-center mt-2.5 mb-5">
                        ...
                        <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">{props.rating || '0.0'}</span>
                    </div>
