    ...
    return (
        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <td className="space-x-2 whitespace-nowrap p-4">
                <button type="button" data-modal-target="edit-user-modal" data-modal-toggle="edit-user-modal" className="bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center rounded-lg px-3 py-2 text-center text-sm font-medium text-white focus:ring-4">
                    <FaRegEdit className="mr-2 h-4 w-4" />
                    Edit user
                </button>
                <button disabled={props.admin === true ? true : false} type="button" data-modal-target="delete-user-modal" data-modal-toggle="delete-user-modal" className={`inline-flex items-center rounded-lg ${props.admin === true ? 'cursor-not-allowed bg-red-900 text-red-700' :  'bg-red-600 text-white hover:bg-red-800' } px-3 py-2 text-center text-sm font-medium   focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900`}>
